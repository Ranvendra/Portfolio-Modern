...
const ProjectCards = [
...

  {
    ...
    title: "Html + CSS + JS",
    imageSrc:
      "https://cdn3d.iconscout.com/3d/free/thumb/free-html-9294875-7578018.png",
  },
];
...
const SkillsSection = () => {
  ...
  return (
    <section
      ...
      className="relative py-20 bg-gradient-to-b from-[#320064] via-[#520064] to-black overflow-hidden"
    >
      {/* section Title  */}
      ...
      <div className="container mx-auto px-4 mb-16 relative z-10">
        <h2
          ref={titleRef}
          className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4 text-white opacity-0"
        >
          Tech Stack
        </h2>
      </div>
            ...
            return (
              ...
              >
                <div className="relative w-[70%] h-[70%] flex flex-col items-center justify-center p-4 sm:p-8 md:p-12 ">
                  ...
                  <h2 className="project-title flex items-center gap-3 md:text-3xl text-sm md:font-bold text-white mt-6 z-50 text-nowrap hover:text-amber-600 transition-colors duration-300 cursor-pointor">
